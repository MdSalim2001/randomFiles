...
<div class ="container contact-container">
   ...
   <?php
    ...
    $prison_man_id = $_SESSION['hm_id'];
    $query = "SELECT * FROM messages WHERE hm_id ='$prison_man_id'";
    ...
    <div class="container">
      ...
      <div class="card-footer"><?php echo $row['prisoner_id'] ?><span style="float: right"><?php echo $row['time_stamp'] ;?></span></div>
  </div>
</div>
<br><br>
