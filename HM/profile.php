...
$query1 = "SELECT * FROM prison_manager WHERE hm_id = '$hm_id'";
...
$query3 = "SELECT * FROM prison WHERE prison_id = '$row1[prison_id]'";
                    ...
                    <div class="row m-l-0 m-r-0" style="width:700px;">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <p>PRISON MANAGER</p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="card-block">
                               ...
                               <br>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600" style="color: black;">Prison-Incharge</p>
                                        <h6 class="text-muted f-w-400"><?php echo $row3['prison_name'];?></h6>
                                    </div>
                                </div>
